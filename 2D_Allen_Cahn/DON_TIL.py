...
def update(params, rk_params, branch_inputs, trunk_inputs, gt_outputs, opt_state, opt_state_rk, dt):
    ...
    loss, grads = jax.value_and_grad(loss_fn, argnums = 0)(params, rk_params, branch_inputs, trunk_inputs, gt_outputs, dt)
    updates, opt_state = optimizer.update(grads, opt_state)
    params = optax.apply_updates(params, updates)
    
    #Update for RK params
    _, rk_grads = jax.value_and_grad(loss_fn, argnums = 1)(params, rk_params, branch_inputs, trunk_inputs, gt_outputs, dt)
...
u_pred = run_inference(u_start, trunk_inputs_test, 
