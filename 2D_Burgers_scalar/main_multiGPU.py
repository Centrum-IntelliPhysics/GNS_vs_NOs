...
def main(log_loss, total_epochs, batch_size):
    ...
    #Only consider amongst first 1000 samples
    outputs_u = outputs_u[:1000]

    #Selecting training trajectories
    num_trajectories = 100
    # selected_trajectories = get_trajectory_idx(outputs_u, num_trajectories, pca_components = 20)
    ...
    print(f"After subselection, outputs_uv dataset shape: {outputs_u_subselected.shape}")
